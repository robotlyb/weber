...
class SubmitsControllerTest < ActionController::TestCase
  ...
  test "should create submit" do
    assert_difference('Submit.count') do
      post :create, submit: { course_id: @submit.course_id, position: @submit.position, user_id: @submit.user_id }
    end
  ...
  test "should update submit" do
    put :update, id: @submit, submit: { course_id: @submit.course_id, position: @submit.position, user_id: @submit.user_id }
    assert_redirected_to submit_path(assigns(:submit))
  end
